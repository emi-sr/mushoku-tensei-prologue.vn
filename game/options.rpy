...
define config.name = _("Mushoku Tensei PrologueVN")
...
define build.name = "MushokuTenseiPrologueVN"
...
define config.save_directory = "MushokuTenseiPrologueVN-1688679288"
